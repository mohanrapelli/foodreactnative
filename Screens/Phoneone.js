                ...
                <View style={styles.container1}>
                    <View style={styles.forgotpage}>
                        <Ionicons
                            ...
                            name="caret-back-outline" size={27} color="black" style={styles.iconn} />
                    ...
                    <View style={styles.inputContainer}>
                        <Image source={require('../assets/india.png')} style={styles.image4} />
                    ...
                    <TouchableOpacity
                        ...
                        <Text
                            ...
                            style={{ color: 'white', alignSelf: 'center' }}>CONFIRM</Text>
                    </TouchableOpacity>
                </View>
